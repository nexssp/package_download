...
if (! $downloadsFolder) {
    nxsError("There was an error with cwd (Nexss Error) however you can fix this error by adding params: ")
    nxsError("--downloadPathCache or direct --downloadsFolder='Yourfolderhere'");
    exit;
}
